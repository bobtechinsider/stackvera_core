...
return [
    ...
    'imprint' => [
        ...
        'register_intro' => 'Entry in the commercial register.',
        'register_court' => 'Register court:',
        'register_number' => 'Register number:',
        'vat_heading' => 'VAT identification number',
        'vat_intro' => 'VAT ID pursuant to § 27a of the German VAT Act (UStG):',
        'responsible_heading' => 'Responsible for content',
        'responsible_intro' => 'Pursuant to § 18 (2) MStV:',
        'responsible_address' => 'Address as above',
    ],
    ...
    'privacy' => [
        ...
        'controller_heading' => '2. Controller',
        'controller_intro' => 'The controller responsible for data processing on this website is:',

        'access_heading' => '3. Data processed when visiting the website',
        ...
        'access_hosting_value' => 'DigitalOcean LLC, 105 Edgeview Drive, Suite 425, Broomfield, CO 80021, USA. The servers we use are located in a data center in Frankfurt am Main, Germany, so your data is stored within the European Union. Because DigitalOcean is a US-based company, access from a third country cannot be entirely excluded. This is safeguarded by a data processing agreement that includes the EU standard contractual clauses (Art. 28 and Art. 46 GDPR).',
        ...
        'rights_erasure' => 'erasure of your data (Art. 17 GDPR);',
